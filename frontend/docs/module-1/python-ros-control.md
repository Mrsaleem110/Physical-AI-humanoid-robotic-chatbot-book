...
1. Create a Python node that controls a simple humanoid robot model
2. Implement PID controllers for at least 6 joints
3. Create a trajectory publisher that moves the robot through a simple motion
4. Add safety limits to prevent joint damage
