...
const ChatbotWidget = () => {
  const [messages, setMessages] = useState([
    {
      id: '1',
      text: 'Hello! I\'m your AI assistant for humanoid robotics. How can I help you today?',
      sender: 'bot',
      timestamp: new Date(),
    }
  ]);
  ...
  // Auto-translate functionality has been removed
    ...
    try {
      ...
      const moduleKnowledgeBase = {
        "module-1": {
          ...
          content: `Module 1 covers the fundamentals of Robot Operating System 2 (ROS 2) and its application to humanoid robotics. Key topics include: ROS 2 architecture, nodes, topics, services, actions, URDF (Unified Robot Description Format) for humanoid robots, Python-based ROS control systems, and basic robot modeling. This module provides the foundational knowledge needed to work with humanoid robots using ROS 2, including how to create publishers, subscribers, services, and how to model humanoid robots with URDF files.`,
          chapters: [
        ...
        "module-2": {
          ...
          content: `Module 2 focuses on simulation environments and physics modeling for humanoid robots. Topics include: Physics simulation fundamentals, gravity and collision modeling, sensor simulation, Unity-based HRI (Human-Robot Interaction) visualization, and realistic environment modeling. Students learn to create realistic simulation environments for humanoid robots, implement physics constraints, model sensors, and visualize robot interactions in Unity. The module also covers collision detection and response systems critical for humanoid robot simulation.`,
          chapters: [
        ...
        "module-3": {
          ...
          content: `Module 3 covers navigation systems and path planning algorithms for humanoid robots. Key topics include: Robot navigation stacks, path planning algorithms (A*, Dijkstra, RRT), obstacle avoidance, SLAM (Simultaneous Localization and Mapping), and humanoid-specific navigation challenges. Students learn to implement navigation systems that account for the unique kinematics and dynamics of humanoid robots, including bipedal locomotion planning and terrain adaptation strategies.`,
          chapters: [
        ...
        "module-4": {
          ...
          content: `Module 4 explores AI and machine learning applications in humanoid robotics. Topics include: Vision-Language-Action (VLA) models, reinforcement learning for humanoid control, computer vision for humanoid robots, natural language processing for HRI, and deep learning applications. Students learn to implement AI systems that enable humanoid robots to perceive their environment, understand human commands, and execute complex tasks using machine learning techniques specifically tailored for humanoid robot platforms.`,
          chapters: [
...
${moduleInfo.chapters.map((ch, idx) => `${idx + 1}. ${ch.name} - ${ch.description}`).join('\n')}`;
        ...
        // For non-module questions, return the original response
        return `I received your message: "${inputValue}". This is a simulated response from the humanoid robotics assistant.`;
      };
  ...
  return (
    <div style={styles.chatWidget}>
      <div style={styles.chatHeader}>
        <h3 style={{ margin: 0, fontSize: '1rem' }}>Humanoid Robotics Assistant</h3>
      </div>
